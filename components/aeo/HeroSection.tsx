    ...
    <section id="top" ref={ref} className="hero hero-orb">
      ...
      <div className="hero-shell">
        <motion.div className="hero-copy" initial="hidden" animate="visible">
          ...
          <motion.div variants={reveal} custom={3} className="hero-actions"><a className="button primary" href="https://scan.orb-itworks.com/scan" target="_blank" rel="noreferrer">Get Free AEO and GEO Audit <span>↗</span></a><a className="button outline" href="https://calendly.com/orbitworksofficial01/30min" target="_blank" rel="noreferrer">Schedule a 30-Minute Strategy Session</a></motion.div>
