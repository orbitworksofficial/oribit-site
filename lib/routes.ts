...
export const ROUTES: Record<string, RouteChrome> = {
  "/": {
    ...
    nav: "white",
    selected: null,
    title: "AI Automation & IT Services Company in USA | Orbit Works",
    description:
  ...
  "/case-studies": {
    ...
    title: "Client Case Studies and Measurable Results | Orbit Works",
  ...
  "/resources": {
    ...
    nav: "black",
    selected: "Resources",
    title: "Free IT, Cloud and Marketing Resources | Orbit Works",
  ...
  "/blogs": {
    ...
    nav: "black",
    selected: "Blogs",
    title: "Insights on AI, Cloud and Growth | Orbit Works Blog",
  ...
  "/contact": {
    ...
    nav: "black",
    selected: "Contact",
    title: "Contact Orbit Works | Book a Free IT Discovery Call",
